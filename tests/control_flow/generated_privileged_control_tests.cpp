...
void run_trapa_and_rte() {
    ...
    require(cpu.tra == 0x000001FCu && cpu.expevt == 0x00000160u,
            "TRAPA schreibt TRA oder EXPEVT falsch.");
    require(cpu.ssr == 0x00000303u && cpu.spc == 0x00000102u && cpu.sgr == 0x12345678u,
            "TRAPA sichert SR, PC oder R15 falsch.");
    require(cpu.read_sr() == 0x70000303u && cpu.pc == 0x00008100u && cpu.trap_pending &&
                cpu.r[0] == 0x22222222u,
    ...
    require(cpu.read_sr() == 0x00000001u && cpu.pc == 0xDEADBEEFu && !cpu.trap_pending,
            "RTE stellt SR, PC oder Trapzustand falsch wieder her.");
    require(cpu.r[0] == 0x11111112u && cpu.r_bank[0] == 0x22222222u,
...
void run_sleep() {
    ...
    require(cpu.r[3] == 0x89ABCDEFu && cpu.read_sr() == 0x40000001u,
