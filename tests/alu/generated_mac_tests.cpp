...
void run_macl_saturation() {
...

    {
        ...
        require(
            cpu.mach == 0x0000FFFFu &&
            cpu.macl == 0xFFFFFFFAu,
...
void run_complete_chain() {
    ...
    require(
        !cpu.s,
        "SETS und CLRS muessen den Einstieg im geloeschten S-Modus verlassen."
    );
...
int main() {
    ...
    std::cout
        << "KR-1303 End-to-End-Semantik wurde erfolgreich ausgefuehrt.\n";
