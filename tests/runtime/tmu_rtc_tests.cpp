...
int main() {
    ...
    require(tmu.underflow_count(1u) == 1u, "RTC-getakteter TMU-Kanal laeuft nicht auf der naechsten 16,384-kHz-Flanke ab.");
    ...
    require(rtc.tick_count() == disabled_ticks,
        "RTCEN=0 laesst den RTC-Teiler weiterlaufen.");
