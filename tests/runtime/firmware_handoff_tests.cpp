...
int main() {
    try {
        ...
        map.map_segment({"boot-rom-p1", FirmwareSegmentKind::Rom, 0x80000000u, 0x00000000u, 0x00200000u});
        map.map_segment({"boot-rom-p2", FirmwareSegmentKind::Rom, 0xA0000000u, 0x00000000u, 0x00200000u});
        map.map_segment({"main-ram", FirmwareSegmentKind::Ram, 0x8C000000u, 0x0C000000u, 0x01000000u});
        ...
        require(p1.physical_address == p2.physical_address && p1.virtual_address != p2.virtual_address,
        ...
        map.install_runtime_symbol({"bios_syscall_vector", 0x8C0000B0u, 0x0C0000B0u, "runtime-install"});
