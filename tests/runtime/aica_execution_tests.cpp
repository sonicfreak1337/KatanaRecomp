...
int main() {
    ...
    require(execution.mode() == AicaArm7Mode::HighLevelAudio && !execution.arm7_executes_instructions(),
    ...
    require(throws<std::invalid_argument>([] { AicaTimer timer; timer.configure(0u, 8u, true); }),
