...
int main() {
    ...
    require(bus.attached(0u, 0u) && bus.attached(3u, 5u), "Maple-Randadressen sind nicht belegbar.");
    require(throws<std::invalid_argument>([&] { bus.attach(0u, 0u, std::make_shared<EchoDevice>()); }),
