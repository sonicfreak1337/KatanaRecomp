...
int main(const int argc, char* argv[]) {
    ...
    require(
        store_b.kind == InstructionKind::MovByteStoreR0Indexed &&
    ...
    require(
        program.size() == 1u,
        "Der KR-1403-Test muss genau eine Funktion erzeugen."
    );
    require(
        count_operation(program, Operation::StoreByteR0Indexed) == 2u &&
    ...
    require(
        count_operation(program, Operation::LoadByteSignedR0Indexed) == 2u &&
    ...
    require(
        source.find("write_u8(cpu.r[0] + cpu.r[2]") != std::string::npos &&
    ...
    require(
        source.find("read_s8(cpu.r[0] + cpu.r[7]") != std::string::npos &&
    ...
    std::cout
        << "Alle KR-1403 Decoder-, IR- und Codegen-Tests erfolgreich.\n";
