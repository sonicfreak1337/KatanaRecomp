...
int main() {
    ...
    image.add_segment({
        ".data", 0x8C000000u, 0u, 2u, katana::io::SegmentKind::Data,
        {true, true, false}, {0xFFu, 0xFFu}
    });
    image.add_segment({
        ".text", 0x8C010000u, 2u, 4u, katana::io::SegmentKind::Code,
        {true, false, true}, {0x09u, 0x00u, 0x0Bu, 0x00u}
    });
    image.add_segment({
        ".unknown", 0x8C020000u, 6u, 2u, katana::io::SegmentKind::Unknown,
    ...
    require(
        image_lines[0].address == 0x8C010000u && image_lines[1].address == 0x8C010002u,
