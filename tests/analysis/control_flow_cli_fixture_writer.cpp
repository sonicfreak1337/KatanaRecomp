...
int main(const int argc, char* argv[]) {
    ...
    constexpr std::array<std::uint8_t, 40> bytes{
        0x0Cu, 0xE1u, 0x0Bu, 0x41u, 0x09u, 0x00u, 0x0Bu, 0x00u, 0x09u, 0x00u,
        0x09u, 0x00u, 0x2Bu, 0x42u, 0x09u, 0x00u, 0x09u, 0x00u, 0x2Bu, 0x43u,
        0x09u, 0x00u, 0x09u, 0x00u, 0x0Bu, 0x00u, 0x09u, 0x00u, 0x0Bu, 0x00u,
        0x09u, 0x00u, 0x18u, 0x00u, 0x00u, 0x00u, 0x1Cu, 0x00u, 0x00u, 0x00u};
    {
        ...
        if (!output) {
            throw std::runtime_error(
                "Synthetische Kontrollfluss-Fixture konnte nicht geschrieben werden.");
        }
    }
    {
