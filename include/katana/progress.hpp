...
struct ProgressCounterSnapshot final {
    ...
    std::optional<std::uint64_t> round_seed_facts_added;
    std::optional<std::uint64_t> round_seed_targets_changed;
    std::optional<std::uint64_t> round_decode_targets;
    std::optional<std::uint64_t> round_metadata_targets;
    std::optional<std::uint64_t> round_full_cpu_fallbacks;
    ...
    std::optional<std::uint64_t> contextual_return_root_index;
    std::optional<std::uint64_t> contextual_return_root_address;
    std::optional<std::uint64_t> contextual_return_current_function_address;
    std::optional<std::uint64_t> contextual_return_limiting_function_address;
    std::optional<std::uint64_t> contextual_return_wave;
    std::optional<std::uint64_t> contextual_return_frontier;
    std::optional<std::uint64_t> contextual_return_maximum_frontier;
    std::optional<std::uint64_t> contextual_return_context_budget;
    std::optional<std::uint64_t> contextual_return_evaluation_budget;
    std::optional<std::uint64_t> contextual_return_contexts_admitted;
    std::optional<std::uint64_t> contextual_return_evaluations_admitted;
    std::optional<bool> contextual_return_context_budget_exhausted;
    std::optional<bool> contextual_return_evaluation_budget_exhausted;
    std::optional<bool> contextual_return_composite_budget_exhausted;
    std::optional<bool> contextual_return_incomplete_root;
    std::optional<bool> contextual_return_retention_enabled;
    std::optional<std::uint64_t> contextual_return_retained_bytes;
    std::optional<std::uint64_t> contextual_return_logical_requests;
    std::optional<std::uint64_t> contextual_return_logical_admissions;
    std::optional<std::uint64_t> contextual_return_semantic_lane_cardinality;
    std::optional<std::uint64_t> contextual_return_physical_evaluations;
    std::optional<std::uint64_t> contextual_return_cache_reuses;
    std::optional<std::uint64_t> contextual_return_exact_subscriber_cardinality;
    std::optional<std::uint64_t> contextual_return_provenance_cardinality;
    std::optional<std::uint64_t> contextual_return_root_lane_creations;
    std::optional<std::uint64_t> contextual_return_descendant_lane_creations;
    std::optional<std::uint64_t> contextual_return_requeues_initial_root_seed;
    std::optional<std::uint64_t> contextual_return_requeues_new_lane;
    std::optional<std::uint64_t> contextual_return_requeues_input_widening;
    std::optional<std::uint64_t> contextual_return_requeues_summary_change;
    std::optional<std::uint64_t> contextual_return_requeues_forward_edge_insert_or_widen;
    std::optional<std::uint64_t> contextual_return_requeues_stale_dependency;
    std::optional<std::uint64_t> contextual_return_stale_snapshot_discards;
    std::optional<std::uint64_t> contextual_return_snapshot_count;
    std::optional<std::uint64_t> contextual_return_snapshot_nanoseconds;
    std::optional<std::uint64_t> contextual_return_key_count;
    std::optional<std::uint64_t> contextual_return_key_nanoseconds;
    std::optional<std::uint64_t> contextual_return_cache_evaluation_count;
    std::optional<std::uint64_t> contextual_return_cache_evaluation_nanoseconds;
    std::optional<std::uint64_t> contextual_return_apply_call_count;
    std::optional<std::uint64_t> contextual_return_apply_call_nanoseconds;
    std::optional<std::uint64_t> contextual_return_binding_lookups;
    std::optional<std::uint64_t> contextual_return_bindings_examined;
    std::optional<std::uint64_t> contextual_return_binding_equality_attempts;
    std::optional<std::uint64_t> contextual_return_binding_merge_attempts;
    std::optional<std::uint64_t> contextual_return_binding_merge_nanoseconds;
    std::optional<std::uint64_t> contextual_return_binding_exact_hits;
    std::optional<std::uint64_t> contextual_return_binding_join_hits;
    std::optional<std::uint64_t> contextual_return_maximum_binding_count;
    std::optional<std::uint64_t> contextual_return_maximum_binding_hit_position;
    std::optional<std::uint64_t> contextual_return_evidence_restore_count;
    std::optional<std::uint64_t> contextual_return_evidence_restore_nanoseconds;
    std::optional<std::uint64_t> contextual_return_serial_commit_count;
    std::optional<std::uint64_t> contextual_return_serial_commit_nanoseconds;
    std::optional<std::uint64_t> contextual_return_publish_count;
    std::optional<std::uint64_t> contextual_return_publish_nanoseconds;
    std::optional<std::uint64_t> contextual_return_maximum_full_state_key_bytes;
    std::optional<std::uint64_t> contextual_return_maximum_projected_key_bytes;
    std::optional<std::uint64_t> contextual_return_maximum_capsule_entries;
    std::optional<std::uint64_t> contextual_return_projected_digest_cardinality;
    std::optional<std::uint64_t> contextual_return_projected_digest_dropped;
    std::optional<bool> contextual_return_projected_digest_degraded;
    std::optional<std::uint64_t> contextual_return_alpha_normalization_fallbacks;
    std::optional<std::uint64_t> contextual_return_semantic_lane_widenings;
    std::optional<std::uint64_t> contextual_return_provenance_only_lane_widenings;
    std::optional<std::uint64_t> contextual_return_lane_widening_classification_dropped;
    std::optional<bool> contextual_return_lane_widening_classification_degraded;
    std::optional<std::uint64_t> contextual_return_telemetry_dropped;
    std::optional<bool> contextual_return_telemetry_degraded;
    ...
    std::optional<std::uint64_t> incremental_epochs_started;
    std::optional<std::uint64_t> resolution_root_artifacts_total;
    std::optional<std::uint64_t> resolution_root_artifacts_reused;
    std::optional<std::uint64_t> resolution_root_artifacts_recomputed;
    std::optional<std::uint64_t> resolution_root_artifacts_retained;
    std::optional<std::uint64_t> resolution_epoch_retained_bytes;
    std::optional<std::string> resolution_retention_limit_reason;
    std::optional<std::uint64_t> dirty_sccs;
    std::optional<std::uint64_t> dirty_functions;
    std::optional<std::uint64_t> dirty_inventory_sinks;
    std::optional<std::uint64_t> full_cpu_recompute_fallbacks;
    std::optional<std::string> persistent_analysis_bypass_reason;
    std::optional<std::uint64_t> recursive_snapshot_epochs;
    std::optional<std::uint64_t> recursive_final_materializations;
    std::optional<std::uint64_t> recursive_trusted_snapshot_validations;
    std::optional<std::uint64_t> recursive_seed_arena_copy_items;
    std::optional<std::uint64_t> recursive_seed_arena_copy_bytes;
    std::optional<std::uint64_t> recursive_seed_arena_shift_items;
    std::optional<std::uint64_t> recursive_seed_arena_shift_bytes;
    std::optional<std::uint64_t> recursive_seed_contract_items_visited;
    std::optional<std::uint64_t> recursive_decoded_work_items;
    std::optional<std::uint64_t> recursive_canonical_context_updates;
    std::optional<std::uint64_t> recursive_canonical_instruction_updates;
    std::optional<std::uint64_t> recursive_canonical_function_updates;
    std::optional<std::uint64_t> recursive_public_baseline_hash_bytes;
    std::optional<std::uint64_t> recursive_public_baseline_copy_items;
    std::optional<std::uint64_t> recursive_public_sort_items;
    std::optional<std::uint64_t> recursive_public_materialized_items;
    std::optional<std::uint64_t> recursive_public_materializations;
    std::optional<std::uint64_t> epoch_index_lookups;
    std::optional<std::uint64_t> epoch_index_updates;
    std::optional<std::uint64_t> terminal_epoch_fold_items;
    std::optional<std::uint64_t> runtime_copy_instruction_visits;
    std::optional<std::uint64_t> runtime_copy_result_entries_visited;
    std::optional<std::uint64_t> runtime_copy_result_entries_rebuilt;
    std::optional<std::uint64_t> local_control_flow_instruction_visits;
    std::optional<std::uint64_t> local_control_flow_result_entries_visited;
    std::optional<std::uint64_t> local_control_flow_result_entries_rebuilt;
    std::optional<std::uint64_t> dispatch_index_entries_visited;
    std::optional<std::uint64_t> dispatch_index_entries_rebuilt;
    std::optional<std::uint64_t> jump_table_instruction_visits;
    std::optional<std::uint64_t> jump_table_result_entries_visited;
    std::optional<std::uint64_t> jump_table_result_entries_rebuilt;
    std::optional<std::uint64_t> function_boundary_entries_visited;
    std::optional<std::uint64_t> function_boundary_entries_rebuilt;
    std::optional<std::uint64_t> function_edge_family_entries_visited;
    std::optional<std::uint64_t> function_edge_family_entries_rebuilt;
    std::optional<std::uint64_t> function_edge_state_encode_items;
    std::optional<std::uint64_t> function_edge_state_copy_items;
    std::optional<std::uint64_t> function_edge_state_exact_compare_items;
    std::optional<std::uint64_t> result_index_copy_items;
    std::optional<std::uint64_t> result_index_sort_items;
    std::optional<std::uint64_t> result_index_materialized_items;
    std::optional<std::uint64_t> program_delta_entries_visited;
    std::optional<std::uint64_t> function_edge_full_scans;
    std::optional<std::uint64_t> function_edge_full_sorts;
    std::optional<std::uint64_t> candidate_call_edge_full_scans;
    std::optional<std::uint64_t> candidate_call_edge_full_sorts;
    std::optional<std::uint64_t> candidate_tail_edge_full_scans;
    std::optional<std::uint64_t> candidate_tail_edge_full_sorts;
    std::optional<std::uint64_t> program_graph_blocks_built;
    std::optional<std::uint64_t> program_graph_blocks_reused;
    std::optional<std::uint64_t> program_graph_sccs_built;
    std::optional<std::uint64_t> program_graph_sccs_reused;
    std::optional<std::uint64_t> resolution_dependency_nodes_built;
    std::optional<std::uint64_t> resolution_dependency_nodes_reused;
    std::optional<std::uint64_t> resolution_dependency_sccs_built;
    std::optional<std::uint64_t> resolution_dependency_sccs_reused;
    std::optional<std::uint64_t> abi_contract_entries_visited;
    std::optional<std::uint64_t> abi_contract_entries_rebuilt;
    std::optional<std::uint64_t> summary_candidate_entries_visited;
    std::optional<std::uint64_t> summary_candidate_entries_rebuilt;
    std::optional<std::uint64_t> inventory_topology_entries_visited;
    std::optional<std::uint64_t> resolution_preparation_entries_visited;
    std::optional<std::uint64_t> final_materialized_blocks;
    std::optional<std::uint64_t> final_materialized_functions;
};
