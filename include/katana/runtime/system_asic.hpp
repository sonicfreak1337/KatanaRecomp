...
class DreamcastSystemBusControl final {
  public:
    ...
    [[nodiscard]] bool texture_memory_mode0_uses_32bit_path() const noexcept;
    [[nodiscard]] bool texture_memory_mode1_uses_32bit_path() const noexcept;
...
enum class SystemAsicEvent : std::uint16_t {
    ...
    PvrIllegalAddress = 0x0206u,
    PvrOverrun = 0x0207u,
    GdromIllegalAddress = 0x020Cu,
    GdromOverrun = 0x020Du,
    GdromAccessError = 0x020Eu,
    AicaDmaIllegalAddress = 0x020Fu,
    Ext1DmaIllegalAddress = 0x0210u,
    Ext2DmaIllegalAddress = 0x0211u,
    DeviceDmaIllegalAddress = 0x0212u,
    AicaDmaOverrun = 0x0213u,
    Ext1DmaOverrun = 0x0214u,
    Ext2DmaOverrun = 0x0215u,
    DeviceDmaOverrun = 0x0216u,
    AicaDmaTimeout = 0x0217u,
    Ext1DmaTimeout = 0x0218u,
    Ext2DmaTimeout = 0x0219u,
    DeviceDmaTimeout = 0x021Au,
    G2CpuTimeout = 0x021Bu
};
