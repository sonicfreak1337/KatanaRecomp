...
inline constexpr std::uint32_t boot_analysis_cache_schema_version = 20u;
inline constexpr std::uint32_t boot_analysis_cache_ir_schema_version = 4u;
inline constexpr std::uint32_t boot_analysis_checkpoint_schema_version = 5u;
