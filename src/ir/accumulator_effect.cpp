...
AccumulatorEffects operation_accumulator_effects(
    ...
    const SpecialRegister special_register
) noexcept {
    switch (operation) {
        ...
        case Operation::StoreSpecialRegisterPreDecrement:
            if (special_register == SpecialRegister::Mach) {
                return {AccumulatorRegister::Mach, AccumulatorRegister::Mach,
                    AccumulatorRegister::None, AccumulatorRegister::None};
            }
            if (special_register == SpecialRegister::Macl) {
                return {AccumulatorRegister::Macl, AccumulatorRegister::Macl,
                    AccumulatorRegister::None, AccumulatorRegister::None};
            }
            return {};
        ...
        case Operation::LoadSpecialRegisterPostIncrement:
            if (special_register == SpecialRegister::Mach) {
                return {AccumulatorRegister::None, AccumulatorRegister::None,
                    AccumulatorRegister::Mach, AccumulatorRegister::Mach};
            }
            if (special_register == SpecialRegister::Macl) {
                return {AccumulatorRegister::None, AccumulatorRegister::None,
                    AccumulatorRegister::Macl, AccumulatorRegister::Macl};
            }
            return {};
        default:
            return {};
