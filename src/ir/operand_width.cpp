...
std::string_view operand_width_name(const OperandWidth width) noexcept {
    switch (width) {
        case OperandWidth::None: return "none";
        case OperandWidth::Bit1: return "i1";
        case OperandWidth::Bits4: return "i4";
        case OperandWidth::Bits8: return "i8";
        case OperandWidth::Bits12: return "i12";
        case OperandWidth::Bits16: return "i16";
        case OperandWidth::Bits32: return "i32";
        case OperandWidth::Bits64: return "i64";
    }
    return "unknown";
}
