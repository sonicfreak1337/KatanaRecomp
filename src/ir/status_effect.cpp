...
constexpr StatusRegisterBit combine(
    const StatusRegisterBit left,
    const StatusRegisterBit right
) noexcept {
    return static_cast<StatusRegisterBit>(
...
StatusRegisterEffects instruction_status_effects(
...
bool contains_status_bit(
    const StatusRegisterBit effects,
    const StatusRegisterBit bit
) noexcept {
