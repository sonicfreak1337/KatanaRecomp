...
DreamcastMediaClock::DreamcastMediaClock(
    ...
    : scheduler_(scheduler),
      ...
      audio_cadence_(make_cadence(
          config.guest_cycles_per_second,
...
DreamcastMediaClock::~DreamcastMediaClock() { stop(); }

DreamcastMediaClock::Cadence DreamcastMediaClock::make_cadence(
    const std::uint64_t cycles_per_second,
    ...
    const auto base = checked_add(
        checked_multiply(whole, units_per_tick),
...
bool DreamcastMediaClock::running() const noexcept { return running_; }
std::uint64_t DreamcastMediaClock::video_tick_count() const noexcept { return video_ticks_; }
std::uint64_t DreamcastMediaClock::audio_tick_count() const noexcept { return audio_ticks_; }
