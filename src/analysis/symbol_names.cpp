...
int binding_rank(const katana::io::SymbolBinding binding) noexcept {
    switch (binding) {
        case katana::io::SymbolBinding::Global: return 0;
        case katana::io::SymbolBinding::Weak: return 1;
        case katana::io::SymbolBinding::Local: return 2;
        case katana::io::SymbolBinding::Unknown: return 3;
    }
    return 4;
}
...
int kind_rank(const katana::io::SymbolKind kind) noexcept {
    switch (kind) {
        case katana::io::SymbolKind::Function: return 0;
        case katana::io::SymbolKind::Object: return 1;
        case katana::io::SymbolKind::Unknown: return 2;
    }
    return 3;
}

bool preferred_symbol(
    const katana::io::ImageSymbol& left,
    const katana::io::ImageSymbol& right
) {
...
SymbolNameIndex::SymbolNameIndex(
    const std::span<const katana::io::ImageSymbol> symbols
...
const SymbolicAddress* find_symbolic_address(
