...
Profilvertrag `5`, Portprojektvertrag `80` und der Linkmap-Audit verhindern
...
Tracesink. Aktiv ist `KR-5002` als naechster Task fuer Audio/Movie. Niemals
den historischen Launcher als Fallback aktivieren.
