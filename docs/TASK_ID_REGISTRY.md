...
Runtime-ABI 101, PlatformServices-ABI 14, Analyzer-ABI 39,
...
| KR-5000 | Native Produktgrenze und Linkisolation | [x] physische Source-/Link-/Installgrenze abgeschlossen; Runtime-ABI 101, Analyzer-ABI 39, Backend-ABI 21, Portprojektvertrag 89, Profilvertrag 13, NativePortDefinition/Artifact/Content/Runtime/Bootstrap, read-only Content-Mappings, Hook-/Hardware-Closure, direkter Dispatch und Linkaudit implementiert; erster Plattformfehler typisiert `UnresolvedHardwareAccess`, kein Fallback |
...
| KR-5005 | Nativer No-Skip-Sonic-Produktlauf | aktiv P0 Alpha-Gate; Film 0 und Overlay-Lifecycle belegt, naechster Blocker statisch gebundene Post-Overlay-Callback-/Function-Pointer-Kante; Film 1/Opening, Memory-Card-Screen und Hauptmenue bleiben offen |
