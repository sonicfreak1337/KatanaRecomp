...
Runtime-ABI 98, PlatformServices-ABI 14, Analyzer-ABI 37,
...
| KR-5000 | Native Produktgrenze und Linkisolation | [x] physische Source-/Link-/Installgrenze abgeschlossen; Runtime-ABI 98, Analyzer-ABI 37, Backend-ABI 20, Portprojektvertrag 87, Profilvertrag 11, NativePortDefinition/Artifact/Content/Runtime/Bootstrap, read-only Content-Mappings, Hook-/Hardware-Closure, direkter Dispatch und Linkaudit implementiert; erster Plattformfehler typisiert `UnresolvedHardwareAccess`, kein Fallback |
...
| KR-5005 | Nativer No-Skip-Sonic-Produktlauf | aktiv P0 Alpha-Gate; generische Content-zu-Texture-Pipeline als naechster Blocker, danach No-Skip bis Memory-Card-Screen/Hauptmenue; Bootstrap/AOT/Linkaudit-Findings geschlossen |
